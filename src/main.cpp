...
const string strMessageMagic = "Vipncoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // Vipncoin: 0.35 days
static const int64 nTargetSpacing = 15; // Vipncoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal vipncoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Vipncoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xaa3c95b2cd150c473f4d6fc8e1882ef0995f7f2b1d52bd8179a432af1787ab30");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Fecha terrestre: 06/Dic/2013. Ayer Mandela died";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1386385089;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 389122782;
        ...
        assert(block.hashMerkleRoot == uint256("0x67710edb0a537e06bc9465a98e9db1b7ce919907bcd270ee04b3a4617ff7627e"));
